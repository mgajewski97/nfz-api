...
const TILES = [
  {
    ...
    description: "Szukaj po nazwie, kodzie lub słowie kluczowym",
    href: "/search",
    badge: "Słownik",
  ...
  },
  {
    ...
    description: "Przeglądaj dostępne tabele statystyczne NFZ",
  ...
  },
  {
    icon: HeartPulse,
    title: "Dane medyczne",
    description: "Przeglądaj rozpoznania ICD-10 i procedury ICD-9",
