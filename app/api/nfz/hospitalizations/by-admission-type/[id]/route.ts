...
import { getHospitalizationsByAdmissionType } from "@/lib/nfz-client";
import {
  buildMeta,
  handleNfzError,
  ok,
...
/**
 * GET /api/nfz/hospitalizations/by-admission-type/[id]
 *
...
export async function GET(
  ...
  try {
    const response = await getHospitalizationsByAdmissionType(idResult.value, {
