...
import { getHospitalizationsByGender } from "@/lib/nfz-client";
import {
  buildMeta,
  handleNfzError,
  ok,
...
/**
 * GET /api/nfz/hospitalizations/by-gender/[id]
 *
...
export async function GET(
  ...
  try {
    const response = await getHospitalizationsByGender(idResult.value, {
