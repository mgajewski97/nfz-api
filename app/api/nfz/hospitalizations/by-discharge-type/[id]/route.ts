...
import { getHospitalizationsByDischargeType } from "@/lib/nfz-client";
import {
  buildMeta,
  handleNfzError,
  ok,
...
/**
 * GET /api/nfz/hospitalizations/by-discharge-type/[id]
 *
...
export async function GET(
  ...
  try {
    const response = await getHospitalizationsByDischargeType(idResult.value, {
